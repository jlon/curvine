...
impl ToPyErr for FsError {
    fn into_py_err(self) -> PyErr {
        ...
        match err_kind {
            ...
            ErrorKind::NotADirectory => PyNotADirectoryError::new_err(self.to_string()),
            ErrorKind::DirNotEmpty => PyIOError::new_err(self.to_string()),
            ErrorKind::IsADirectory => PyIsADirectoryError::new_err(self.to_string()),
            ...
            ErrorKind::InvalidArgument => PyValueError::new_err(self.to_string()),
